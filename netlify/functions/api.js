// Importamos las herramientas, usando la versión que funcionaba en Replit
import serverless from 'serverless-http';
import 'dotenv/config';
import express from 'express';
import cors from 'cors';
import { GoogleGenAI, Modality } from '@google/genai'; // <-- USA @google/genai, como en Replit
...
app.post('/api/generate', async (req, res) => {
  try {
    ...
    // Adaptación para Netlify: Devolvemos la imagen directamente
...
// Exportamos el handler para que Netlify lo use (reemplaza a app.listen)
